...
public class ExcelHandler {
    ...
    public static Object[][] commonDataProvider(Method method){
        ...
        Class<?> modelClass = getMethodClass(testClassName);
        ...
        try(FileInputStream file = new FileInputStream(new File(filePath))){
            ...
            while (rowIterator.hasNext()){
               ...
               for (int i = 0;i < headers.size();i++){
                   ...
                   String cellValue = (cell.getCellType() == CellType.STRING) ? cell.getStringCellValue() : String.valueOf((int)cell.getNumericCellValue());
            ...
            throw new RuntimeException("Error in reading in the excel file "+e);
        }
    ...
    private static Class<?> getMethodClass(String testClassName) {
